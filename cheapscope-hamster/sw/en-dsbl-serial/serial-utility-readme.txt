...
Behind the scenes it automatically edits both /boot/cmdline.txt and /etc/innittab, adding or removing the ttyAMA0 options as necessary. The very first time you run rpi-serial-console it automatically creates backup copies of these files with a .bak extension.
