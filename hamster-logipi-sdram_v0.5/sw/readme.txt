...
- ensure that rpi ttyAMA0 is not being used by system (used by default): 
	- Easy utility to all user access to serial port - install using: sudo wget https://raw.github.com/lurch/rpi-serial-console/master/rpi-serial-console -O /usr/bin/rpi-serial-console && sudo chmod +x /usr/bin/rpi-serial-console
